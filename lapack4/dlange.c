...
LONG DOUBLE dlange_(char *norm, int *m, int *n, LONG DOUBLE *a, int 
#endif
#ifdef Q_C_PREFIX_SUFFIX
LONG DOUBLE qlange(char *norm, int *m, int *n, LONG DOUBLE *a, int 
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
LONG DOUBLE qlange_(char *norm, int *m, int *n, LONG DOUBLE *a, int 
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
	    qlassq(m, &A(1,j), &c__1, &scale, &sum);
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
	    qlassq_(m, &A(1,j), &c__1, &scale, &sum);
#endif
