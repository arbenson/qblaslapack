...
/* Subroutine */ void dger_(int *m, int *n, LONG DOUBLE *alpha, 
#endif
#ifdef Q_C_PREFIX_SUFFIX
/* Subroutine */ void qger(int *m, int *n, LONG DOUBLE *alpha, 
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
/* Subroutine */ void qger_(int *m, int *n, LONG DOUBLE *alpha, 
#endif
