...
/* Subroutine */ void dgemv_(char *trans, int *m, int *n, LONG DOUBLE *
#endif
#ifdef Q_C_PREFIX_SUFFIX
/* Subroutine */ void qgemv(char *trans, int *m, int *n, LONG DOUBLE *
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
/* Subroutine */ void qgemv_(char *trans, int *m, int *n, LONG DOUBLE *
#endif
