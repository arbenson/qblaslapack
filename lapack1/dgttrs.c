...
/* Subroutine */ void dgttrs_(char *trans, int *n, int *nrhs, 
#endif
#ifdef Q_C_PREFIX_SUFFIX
/* Subroutine */ void qgttrs(char *trans, int *n, int *nrhs, 
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
/* Subroutine */ void qgttrs_(char *trans, int *n, int *nrhs, 
#endif

	LONG DOUBLE *dl, LONG DOUBLE *d, LONG DOUBLE *du, LONG DOUBLE *du2, 
	int *ipiv, LONG DOUBLE *b, int *ldb, int *info)
{
