...
/* Subroutine */ void dgtsv_(int *n, int *nrhs, LONG DOUBLE *dl, 
#endif
#ifdef Q_C_PREFIX_SUFFIX
/* Subroutine */ void qgtsv(int *n, int *nrhs, LONG DOUBLE *dl, 
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
/* Subroutine */ void qgtsv_(int *n, int *nrhs, LONG DOUBLE *dl, 
#endif

	LONG DOUBLE *d, LONG DOUBLE *du, LONG DOUBLE *b, int *ldb, int *
	info)
{
