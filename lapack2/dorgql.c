...
/* Subroutine */ void dorgql_(int *m, int *n, int *k, LONG DOUBLE *
#endif
#ifdef Q_C_PREFIX_SUFFIX
/* Subroutine */ void qorgql(int *m, int *n, int *k, LONG DOUBLE *
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
/* Subroutine */ void qorgql_(int *m, int *n, int *k, LONG DOUBLE *
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
    qorg2l(&i__1, &i__2, &i__3, &A(1,1), lda, &TAU(1), &WORK(1), &iinfo)
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
    qorg2l_(&i__1, &i__2, &i__3, &A(1,1), lda, &TAU(1), &WORK(1), &iinfo)
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
		qlarfb("Left", "No transpose", "Backward", "Columnwise", &
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
		qlarfb_("Left", "No transpose", "Backward", "Columnwise", &
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
	    qorg2l(&i__3, &ib, &ib, &A(1,*n-*k+i), lda, &
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
	    qorg2l_(&i__3, &ib, &ib, &A(1,*n-*k+i), lda, &
#endif
