...
/* Subroutine */ void dorm2r_(char *side, char *trans, int *m, int *n, 
#endif
#ifdef Q_C_PREFIX_SUFFIX
/* Subroutine */ void qorm2r(char *side, char *trans, int *m, int *n, 
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
/* Subroutine */ void qorm2r_(char *side, char *trans, int *m, int *n, 
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
	qlarf(side, &mi, &ni, &A(i,i), &c__1, &TAU(i), &C(ic,jc), ldc, &WORK(1));
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
	qlarf_(side, &mi, &ni, &A(i,i), &c__1, &TAU(i), &C(ic,jc), ldc, &WORK(1));
#endif
