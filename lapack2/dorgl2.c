...
/* Subroutine */ void dorgl2_(int *m, int *n, int *k, LONG DOUBLE *
#endif
#ifdef Q_C_PREFIX_SUFFIX
/* Subroutine */ void qorgl2(int *m, int *n, int *k, LONG DOUBLE *
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
/* Subroutine */ void qorgl2_(int *m, int *n, int *k, LONG DOUBLE *
#endif
...
#ifdef PETSC_PREFIX_SUFFIX
		dlarf_("Right", &i__1, &i__2, &A(i,i), lda, &TAU(i)
#endif
#ifdef Q_C_PREFIX_SUFFIX
		qlarf("Right", &i__1, &i__2, &A(i,i), lda, &TAU(i)
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
		qlarf_("Right", &i__1, &i__2, &A(i,i), lda, &TAU(i)
#endif
...
#ifdef PETSC_PREFIX_SUFFIX
	    dscal_(&i__1, &d__1, &A(i,i+1), lda);
#endif
#ifdef Q_C_PREFIX_SUFFIX
	    qscal(&i__1, &d__1, &A(i,i+1), lda);
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
	    qscal_(&i__1, &d__1, &A(i,i+1), lda);
#endif
