...
/* Subroutine */ void dlarfx_(char *side, int *m, int *n, LONG DOUBLE *
#endif
#ifdef Q_C_PREFIX_SUFFIX
/* Subroutine */ void qlarfx(char *side, int *m, int *n, LONG DOUBLE *
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
/* Subroutine */ void qlarfx_(char *side, int *m, int *n, LONG DOUBLE *
#endif

	v, LONG DOUBLE *tau, LONG DOUBLE *c, int *ldc, LONG DOUBLE *work)
{
/*  -- LAPACK auxiliary routine (version 2.0) --   
    ...
    V       (input) LONG DOUBLE PRECISION array, dimension (M) if SIDE = 'L'   
                                       or (N) if SIDE = 'R'   
   ...
   Parameter adjustments   
    ...
    static LONG DOUBLE t1, t2, t3, t4, t5, t6, t7, t8, t9, v1, v2, v3, v4, v5, 
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
	qgemv("Transpose", m, n, &c_b14, &C(1,1), ldc, &V(1), &c__1, &
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
	qgemv_("Transpose", m, n, &c_b14, &C(1,1), ldc, &V(1), &c__1, &
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
	qger(m, n, &d__1, &V(1), &c__1, &WORK(1), &c__1, &C(1,1), ldc);
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
	qger_(m, n, &d__1, &V(1), &c__1, &WORK(1), &c__1, &C(1,1), ldc);
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
	qgemv("No transpose", m, n, &c_b14, &C(1,1), ldc, &V(1), &c__1, 
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
	qgemv_("No transpose", m, n, &c_b14, &C(1,1), ldc, &V(1), &c__1, 
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
	qger(m, n, &d__1, &WORK(1), &c__1, &V(1), &c__1, &C(1,1), ldc);
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
	qger_(m, n, &d__1, &WORK(1), &c__1, &V(1), &c__1, &C(1,1), ldc);
#endif
