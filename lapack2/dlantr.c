...
LONG DOUBLE dlantr_(char *norm, char *uplo, char *diag, int *m, int *n,
#endif
#ifdef Q_C_PREFIX_SUFFIX
LONG DOUBLE qlantr(char *norm, char *uplo, char *diag, int *m, int *n,
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
LONG DOUBLE qlantr_(char *norm, char *uplo, char *diag, int *m, int *n,
#endif

	 LONG DOUBLE *a, int *lda, LONG DOUBLE *work)
{
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
		    qlassq(&i__2, &A(MIN(*m,j+1),j), &c__1, &
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
		    qlassq_(&i__2, &A(MIN(*m,j+1),j), &c__1, &
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
		    qlassq(&i__2, &A(j,j), &c__1, &scale, &sum);
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
		    qlassq_(&i__2, &A(j,j), &c__1, &scale, &sum);
#endif
