...
/* Subroutine */ void dlaruv_(int *iseed, int *n, LONG DOUBLE *x)
#endif
#ifdef Q_C_PREFIX_SUFFIX
/* Subroutine */ void qlaruv(int *iseed, int *n, LONG DOUBLE *x)
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
/* Subroutine */ void qlaruv_(int *iseed, int *n, LONG DOUBLE *x)
#endif
...
/*        Convert 48-bit int to a real number in the interval (0,1
	...
	X(i) = ((LONG DOUBLE) it1 + ((LONG DOUBLE) it2 + ((LONG DOUBLE) it3 + (
		LONG DOUBLE) it4 * 2.44140625e-4) * 2.44140625e-4) * 
