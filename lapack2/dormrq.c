...
/* Subroutine */ void dormrq_(char *side, char *trans, int *m, int *n, 
#endif
#ifdef Q_C_PREFIX_SUFFIX
/* Subroutine */ void qormrq(char *side, char *trans, int *m, int *n, 
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
/* Subroutine */ void qormrq_(char *side, char *trans, int *m, int *n, 
#endif
...
#ifdef PETSC_PREFIX_SUFFIX
    extern /* Subroutine */ void dormr2_(char *, char *, int *, int *, 
#endif
#ifdef Q_C_PREFIX_SUFFIX
    extern /* Subroutine */ void qormr2(char *, char *, int *, int *, 
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
    extern /* Subroutine */ void qormr2_(char *, char *, int *, int *, 
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
	qormr2(side, trans, m, n, k, &A(1,1), lda, &TAU(1), &C(1,1)
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
	qormr2_(side, trans, m, n, k, &A(1,1), lda, &TAU(1), &C(1,1)
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
	    qlarft("Backward", "Rowwise", &i__4, &ib, &A(i,1), lda, &
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
	    qlarft_("Backward", "Rowwise", &i__4, &ib, &A(i,1), lda, &
#endif
...
#ifdef PETSC_PREFIX_SUFFIX
	    dlarfb_(side, transt, "Backward", "Rowwise", &mi, &ni, &ib, &A(i,1), lda, t, &c__65, &C(1,1), ldc, &WORK(1), &
#endif
#ifdef Q_C_PREFIX_SUFFIX
	    qlarfb(side, transt, "Backward", "Rowwise", &mi, &ni, &ib, &A(i,1), lda, t, &c__65, &C(1,1), ldc, &WORK(1), &
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
	    qlarfb_(side, transt, "Backward", "Rowwise", &mi, &ni, &ib, &A(i,1), lda, t, &c__65, &C(1,1), ldc, &WORK(1), &
#endif
