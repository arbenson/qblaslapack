...
/* Subroutine */ void dormr2_(char *side, char *trans, int *m, int *n, 
#endif
#ifdef Q_C_PREFIX_SUFFIX
/* Subroutine */ void qormr2(char *side, char *trans, int *m, int *n, 
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
/* Subroutine */ void qormr2_(char *side, char *trans, int *m, int *n, 
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
	qlarf(side, &mi, &ni, &A(i,1), lda, &TAU(i), &C(1,1), 
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
	qlarf_(side, &mi, &ni, &A(i,1), lda, &TAU(i), &C(1,1), 
#endif
