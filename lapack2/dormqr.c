...
/* Subroutine */ void dormqr_(char *side, char *trans, int *m, int *n, 
#endif
#ifdef Q_C_PREFIX_SUFFIX
/* Subroutine */ void qormqr(char *side, char *trans, int *m, int *n, 
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
/* Subroutine */ void qormqr_(char *side, char *trans, int *m, int *n, 
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
	qorm2r(side, trans, m, n, k, &A(1,1), lda, &TAU(1), &C(1,1)
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
	qorm2r_(side, trans, m, n, k, &A(1,1), lda, &TAU(1), &C(1,1)
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
	    qlarft("Forward", "Columnwise", &i__4, &ib, &A(i,i), 
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
	    qlarft_("Forward", "Columnwise", &i__4, &ib, &A(i,i), 
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
	    qlarfb(side, trans, "Forward", "Columnwise", &mi, &ni, &ib, &A(i,i), lda, t, &c__65, &C(ic,jc), ldc, 
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
	    qlarfb_(side, trans, "Forward", "Columnwise", &mi, &ni, &ib, &A(i,i), lda, t, &c__65, &C(ic,jc), ldc, 
#endif
