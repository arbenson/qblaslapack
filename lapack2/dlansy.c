...
LONG DOUBLE dlansy_(char *norm, char *uplo, int *n, LONG DOUBLE *a, int 
#endif
#ifdef Q_C_PREFIX_SUFFIX
LONG DOUBLE qlansy(char *norm, char *uplo, int *n, LONG DOUBLE *a, int 
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
LONG DOUBLE qlansy_(char *norm, char *uplo, int *n, LONG DOUBLE *a, int 
#endif

	*lda, LONG DOUBLE *work)
{
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
		qlassq(&i__2, &A(j+1,j), &c__1, &scale, &sum);
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
		qlassq_(&i__2, &A(j+1,j), &c__1, &scale, &sum);
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
	qlassq(n, &A(1,1), &i__1, &scale, &sum);
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
	qlassq_(n, &A(1,1), &i__1, &scale, &sum);
#endif
