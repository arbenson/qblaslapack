...
/* Subroutine */ void dsbevx_(char *jobz, char *range, char *uplo, int *n, 
#endif
#ifdef Q_C_PREFIX_SUFFIX
/* Subroutine */ void qsbevx(char *jobz, char *range, char *uplo, int *n, 
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
/* Subroutine */ void qsbevx_(char *jobz, char *range, char *uplo, int *n, 
#endif

	int *kd, LONG DOUBLE *ab, int *ldab, LONG DOUBLE *q, int *
	ldq, LONG DOUBLE *vl, LONG DOUBLE *vu, int *il, int *iu, 
	LONG DOUBLE *abstol, int *m, LONG DOUBLE *w, LONG DOUBLE *z, int 
	*ldz, LONG DOUBLE *work, int *iwork, int *ifail, int *info)
{
/*  -- LAPACK driver routine (version 2.0) --   
    ...
    WORK    (workspace) LONG DOUBLE PRECISION array, dimension (7*N)   
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
    qsbtrd(jobz, uplo, n, kd, &AB(1,1), ldab, &WORK(indd), &WORK(inde),
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
    qsbtrd_(jobz, uplo, n, kd, &AB(1,1), ldab, &WORK(indd), &WORK(inde),
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
	    qlacpy("A", n, n, &Q(1,1), ldq, &Z(1,1), ldz);
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
	    qlacpy_("A", n, n, &Q(1,1), ldq, &Z(1,1), ldz);
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
	    qcopy(n, &Z(1,j), &c__1, &WORK(1), &c__1);
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
	    qcopy_(n, &Z(1,j), &c__1, &WORK(1), &c__1);
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
	    qgemv("N", n, n, &c_b14, &Q(1,1), ldq, &WORK(1), &c__1, &
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
	    qgemv_("N", n, n, &c_b14, &Q(1,1), ldq, &WORK(1), &c__1, &
#endif
