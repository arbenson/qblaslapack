...
#include <string.h>
#define s_cmp(a,b,c,d) strcmp(a,b)
#define  MIN(a,b)      ( ((a)<(b)) ? (a) : (b) )

int ilaenv_(int *ispec, char *name, char *opts, int *n1, int *
	n2, int *n3, int *n4, long int name_len, long int opts_len)
{
...
/*     Convert NAME to upper case if the first character is lower case. */
    ...
    ret_val = 1;
    strncpy(subnam,name,MIN(6,name_len));
...
/*     ISPEC = 1:  block size   
       ...
       single or LONG DOUBLE precision. */
...
/*     ISPEC = 6:  crossover point for SVD (used by xGELSS and xGESVD) */
    ...
    ret_val = (int) ((LONG DOUBLE) MIN(*n1,*n2) * 1.6f);
    return ret_val;
