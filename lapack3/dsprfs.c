...
/* Subroutine */ void dsprfs_(char *uplo, int *n, int *nrhs, 
#endif
#ifdef Q_C_PREFIX_SUFFIX
/* Subroutine */ void qsprfs(char *uplo, int *n, int *nrhs, 
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
/* Subroutine */ void qsprfs_(char *uplo, int *n, int *nrhs, 
#endif

	LONG DOUBLE *ap, LONG DOUBLE *afp, int *ipiv, LONG DOUBLE *b, 
	int *ldb, LONG DOUBLE *x, int *ldx, LONG DOUBLE *ferr, 
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
	    qsptrs(uplo, n, &c__1, &AFP(1), &IPIV(1), &WORK(*n + 1), n, info);
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
		qsptrs(uplo, n, &c__1, &AFP(1), &IPIV(1), &WORK(*n + 1), n, 
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
