...
/* Subroutine */ void dsyrfs_(char *uplo, int *n, int *nrhs, 
#endif
#ifdef Q_C_PREFIX_SUFFIX
/* Subroutine */ void qsyrfs(char *uplo, int *n, int *nrhs, 
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
/* Subroutine */ void qsyrfs_(char *uplo, int *n, int *nrhs, 
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
	    qsytrs(uplo, n, &c__1, &AF(1,1), ldaf, &IPIV(1), &WORK(*n 
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
	    qsytrs_(uplo, n, &c__1, &AF(1,1), ldaf, &IPIV(1), &WORK(*n 
#endif
...
#endif
#ifdef Q_C_PREFIX_SUFFIX
		qsytrs(uplo, n, &c__1, &AF(1,1), ldaf, &IPIV(1), &WORK(
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
		qsytrs_(uplo, n, &c__1, &AF(1,1), ldaf, &IPIV(1), &WORK(
#endif
