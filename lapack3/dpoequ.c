...
/* Subroutine */ void dpoequ_(int *n, LONG DOUBLE *a, int *lda, 
#endif
#ifdef Q_C_PREFIX_SUFFIX
/* Subroutine */ void qpoequ(int *n, LONG DOUBLE *a, int *lda, 
#endif
#ifdef Q_NORMAL_PREFIX_SUFFIX
/* Subroutine */ void qpoequ_(int *n, LONG DOUBLE *a, int *lda, 
#endif
